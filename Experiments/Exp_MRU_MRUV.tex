...
\begin{question}[type={exam}]{2}
Calcule o deslocamento $\Delta x$ e o tempo médio $\mean{t}$ para dos dados das Tabelas~\ref{DadosMRU} e~\ref{DadosMRU2}. Observe o número adequado de algarismos significativos e unidades.
\end{question}
...
Calcule o o deslocamento $\Delta x$ e o tempo médio $\mean{t}$ para os dados da Tabela~\ref{DadosMRUV}. Observe o número adequado de algarismos significativos e unidades.
\end{question}
