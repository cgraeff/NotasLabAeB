...
\begin{marginfigure}
\includegraphics[width=\linewidth]{Ilustrations/AparatoQuedaLivre.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Aparato com um sensor:}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{enumerate}
	...
	\item Prenda a esfera no eletroímã;
	\item Posicione o sensor inferior \np[cm]{5,00} abaixo da esfera e anote o valor de sua posição\footnote{Use a escala do próprio suporte vertical do aparato.} na Tabela~\ref{DadosMRUV};
	...
	\item Desloque o sensor inferior mais \np[cm]{5,0} anotando o valor de sua nova posição na Tabela~\ref{DadosMRUV};\label{ItemLoopMRUV2}
