...
\\
	...
	\cmidrule{2-3}
\\
	& \multicolumn{2}{l}{\textbf{Dados para o gráfico $v_t \times \sen\theta$}} && \multicolumn{2}{l}{\textbf{Dados para o gráfico $v_t^2 \times \sen\theta$}} \\
	\cmidrule{2-3} \cmidrule{5-6}
	& $v_t$ & $\sen\theta$ & & $v_t^2$ & $\sen\theta$ &\\
	\cmidrule{2-3} \cmidrule{5-6}
