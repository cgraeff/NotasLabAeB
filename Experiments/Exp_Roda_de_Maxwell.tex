...
\begin{marginfigure}
    ...
    \begin{tikzpicture}[>=Stealth, scale = 0.8]
        ...
        \draw[pattern = north east lines] (0.5, 2) rectangle (-0.5, 1.5) (0.5, -2) rectangle (-0.5, -1.5);
        \draw[pattern = north west lines] (-0.25,-1.5) rectangle (0.25,1.5);
        \draw[pattern = north east lines] (-0.5,0.5) rectangle (-0.25,-0.5) (0.5,0.5) rectangle (0.25,-0.5);
        \draw[pattern = north west lines] (-3,0.25) rectangle (-0.5,-0.25) (3,0.25) rectangle (0.5,-0.25);
