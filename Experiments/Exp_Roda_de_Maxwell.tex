...
\begin{equation}\label{Eq:MomentoDeInerciaDisco}
...
\draw (0,-0.1) ellipse (0.35 and 0.20);
\draw[fill=white] (0,0.05) ellipse (0.35 and 0.20);
...
%%% Semieixo direito
\fill[white] (0.125,0.05) rectangle (-0.125,2);
\draw (0.125,0.05) -- +(0,2.075);
\draw (-0.125,0.05) -- +(0,2.075);
\draw (0,2.125) ellipse (0.125 and 0.075);
\draw (-0.125,0.05) arc[start angle = 180, end angle = 360, x radius = 0.125, y radius = 0.075];
...
\begin{tikzpicture}[>=Stealth, scale = 0.8,
    ...
    \draw[dotted] (0,0.25) -- (1.10,0.25);
    \draw[|<-] (1.10,0.25) -- (1.10,0.75);
    \draw[|<-] (1.10,0) -- node[below right]{$r$} (1.10,-0.5);
    
    \draw[dotted] (0,0.5) -- (0.75,0.5);
    \draw[|<-] (0.75,0.5) -- node[left]{$r_\ell$} (0.75,1);
...
\begin{marginfigure}[7.5cm]
    ...
    \begin{tikzpicture}[>=Stealth, scale = 0.8]
        ...
        \draw[pattern = north west lines] (0, 2) -- (0.5, 2) -- (0.5, 1.5) -- (0.25, 1.5) -- (0.25, 0.5) -- (0.5, 0.5) -- (0.5, 0.25) -- (3, 0.25) -- (3, -0.25) -- (0.5, -0.25) -- (0.5, -0.5) -- (0.25, -0.5) -- (0.25, -1.5) -- (0.5, -1.5) -- (0.5, -2) -- (-0.5, -2) -- (-0.5, -1.5) -- (-0.25, -1.5) -- (-0.25, -0.5) -- (-0.5, -0.5) -- (-0.5, -0.25) -- (-3, -0.25) -- (-3, 0.25) -- (-0.5, 0.25) -- (-0.5, 0.5) -- (-0.25, 0.5) -- (-0.25, 1.5) -- (-0.5, 1.5) -- (-0.5, 2) -- cycle;
        
        \draw[|<->|] (-3,-0.675) -- node[below]{$L$} (-0.5,-0.675);
        \draw[|<->|] (3,-0.675) -- node[below]{$L$} (0.5,-0.675);
        \draw[dotted] (-3,-0.675) -- (-3,-0.25);
        \draw[dotted] (3,-0.675) -- (3,-0.25);
        
        \draw[->|] (-1.5,0.675) -- node[above]{$L_\ell$} (-0.5,0.675);
        %\draw[|<-] (-0.25,0.675) -- (0.75,0.675);
        
        \draw[|<->|] (-0.5, 2.5) -- node[above]{$L_e$} (0.5,2.5);
        \draw[dotted] (-0.5, 2) -- (-0.5, 2.5);
        \draw[dotted] (0.5, 2) -- (0.5, 2.5);
        
        \draw[->] (-1,-1.25) -- node[below left]{$L_i$} (-0.25,-1.25);
        \draw[->] (1,-1.25) -- (0.25,-1.255);
...
\begin{marginfigure}
    ...
    \begin{tikzpicture}[>=Stealth, scale = 0.8]
        ...
        \draw[gray, pattern color=gray, pattern = north east lines] (0.5, 2) rectangle (-0.5, 1.5) (0.5, -2) rectangle (-0.5, -1.5);
        \draw[gray, pattern color=gray, pattern = north west lines] (-0.25,-1.5) rectangle (0.25,1.5);
        \draw[gray, pattern color=gray, pattern = north east lines] (-0.5,0.5) rectangle (-0.25,-0.5) (0.5,0.5) rectangle (0.25,-0.5);
        \draw[gray, pattern color=gray, pattern = north west lines] (-3,0.25) rectangle (-0.5,-0.25) (3,0.25) rectangle (0.5,-0.25);
