...
\ref{Tab:DadosZeroAbsoluto}.\footnote{Como ajustamos a altura do nível da coluna d'água na extremidade ligada ao balão para que ele correspondesse ao da mesa, basta verificarmos a algura em relação à superfície da mesa.}
