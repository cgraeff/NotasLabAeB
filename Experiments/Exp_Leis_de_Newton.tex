...
\begin{question}[type={exam}]
Elabore\footnote{Na verdade, em ambos os casos o deslocamento $\Delta x$ é a variável independente. Por questões didáticas, no entanto, estamos optando por tratar o tempo como variável independente.} um gráfico $\Delta x \times t$.
\end{question}
