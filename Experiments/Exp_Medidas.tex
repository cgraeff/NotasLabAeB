...
\textbf{Atenção:} Escolha um paralelepípedo e um cilindro e os utilize no decorrer do experimento. Anote os resultados obtidos nas próximas seções na Tabela~\ref{Tab:DadosMedidasCorposSolidos}, sempre observando o número de algarismos significativos adequados.
...
\marginpar{\footnotesize$^*$ Algumas medidas podem não ser possíveis com o micrômetro disponível. Preencha a tabela com o valor mais preciso disponível, isto é, com o resultado obtido usando o paquímetro.}

\marginpar{\footnotesize$^\dagger$ Use o resultado mais preciso disponível para o volume ao determinar as densidades.}
