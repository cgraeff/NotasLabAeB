...
\item $2{,}20\,\text{L} \times 1{,}50\,\text{L}$
\item $3{,}45 \cdot 10^5\,\text{m} \div 1{,}5 \cdot 10^2\,\text{s}$
\item $6{,}40 \cdot 10^{3}\,\text{m}^2 \times 1{,}67 \cdot 10^{-2}\,\text{kg}$
...
\item $\dfrac{4{,}0\,\text{m}}{2{,}0} + \sqrt{9{,}0\,\text{m}^2}$
